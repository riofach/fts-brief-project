...
import { useBriefsByClient, useBriefStatistics } from '@/hooks/useBriefs';
...
const ClientDashboard: React.FC = () => {
	...
	const { data: stats, isLoading: statsLoading } = useBriefStatistics(isAuthenticated);
				...
				<div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
					<div className="text-center">
						...
						<p className="text-muted-foreground mt-2">
							Failed to load your project briefs. Please try again.
						</p>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				...
				<Card className="bg-card shadow-lg">
					<CardHeader>
						...
						<CardDescription>View and manage all your submitted project briefs</CardDescription>
					</CardHeader>
					<CardContent>
						{userBriefs.length === 0 ? (
