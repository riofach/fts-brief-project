        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-3 font-semibold text-foreground text-lg">PT Fujiyama Technology Solutions</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/login">
                  <Button size="lg" className="shadow-lg hover:shadow-xl transition-all text-base px-8 py-6">
                    Talk to Advisor
                  </Button>
                </Link>
                <Link to="/login">
            ...
            <div className="relative lg:h-[600px] h-[400px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-8">
                  <FileText className="w-32 h-32 mx-auto text-primary/40 mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              You focus on what matters most - your vision and goals. We handle the complexity 
              of project management, collaboration, and delivery.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-card border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Comprehensive project specifications with brand details, design preferences, and requirements
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Seamless communication between clients and development teams throughout the project
                </p>
              </CardContent>
            </Card>
          ...
          <div className="bg-card rounded-3xl p-12 sm:p-20 text-center shadow-2xl border relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/login">
                  <Button size="lg" className="w-full sm:w-auto shadow-xl hover:shadow-2xl transition-all text-base px-10 py-7">
                    Login as Client
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>
                <Link to="/login">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto text-base px-10 py-7 border-2">
                    Admin Login
                  </Button>
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Leading web development company specializing in innovative digital solutions 
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link to="/login" className="hover:text-primary transition-colors">Create Brief</Link></li>
                <li><Link to="/login" className="hover:text-primary transition-colors">Projects</Link></li>
              </ul>
            </div>
