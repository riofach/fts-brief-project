				...
				<div className="mb-8">
					...
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
						<div>
							...
							<p className="mt-2 text-muted-foreground">
								Submitted by: {brief.clientName || 'Unknown Client'}
							</p>
						</div>
						...
						{deliverables && deliverables.length > 0 && (
							<Card className="bg-card shadow-lg">
								<CardHeader>
									...
									<CardDescription>Files and links shared by the FTS team</CardDescription>
								</CardHeader>
								<CardContent>
										...
										discussions?.map((discussion: Discussion) => {
											...
											return (
												<div
													key={discussion.id}
													className={`flex ${
														discussion.userId === user?.id ? 'justify-end' : 'justify-start'
													} relative group`}
												>
													<div
																...
																<AlertDialog>
																	...
																	<AlertDialogContent>
																		...
																		<AlertDialogFooter>
																			...
																			<AlertDialogAction
																				onClick={() =>
																					handleDeleteDiscussion(discussion.id, discussion.message)
																				}
																				disabled={isDeleting}
